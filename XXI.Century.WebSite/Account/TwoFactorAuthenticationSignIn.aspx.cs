...
using XXI.Century.WebSite.Models.XXICentury;
...
namespace XXI.Century.WebSite.Account
{
    public partial class TwoFactorAuthenticationSignIn : System.Web.UI.Page
    {
        ...
        {
            var userId = signinManager.GetVerifiedUserId<ApplicationUser, long>();
            if (userId == null)
            {
        ...
        protected void CodeSubmit_Click(object sender, EventArgs e)
        {
            ...
            var result = signinManager.TwoFactorSignIn<ApplicationUser, long>(SelectedProvider.Value, Code.Text, isPersistent: rememberMe, rememberBrowser: RememberBrowser.Checked);
            switch (result)
            {
        ...
        protected void ProviderSubmit_Click(object sender, EventArgs e)
        {
            ...
            var user = manager.FindById(signinManager.GetVerifiedUserId<ApplicationUser, long>());
            if (user != null)
            {

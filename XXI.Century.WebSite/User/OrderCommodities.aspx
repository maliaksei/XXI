<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OrderCommodities.aspx.cs" Inherits="XXI.Century.WebSite.User.OrderCommodities" %>
        ...
        <div class="row">
            ...
            <div class="col-sm-9 padding-right">
                <div class="blog-post-area">
                    ...
                    <div>
                        <a class="btn btn-primary" onserverclick="CompletedOrder_Click" runat="server">Подтвердить получение</a>
                    </div>
                </div>
            </div>
        </div>
